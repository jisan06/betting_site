        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" placeholder="Club Name" name="name" value="{{ old('name') }}">
                    @if ($errors->has('name'))
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group {{ $errors->has('orderBy') ? ' has-danger' : '' }}">
                            <input type="number" class="form-control" placeholder="Order By" name="order_by" value="{{ old('orderBy') }}">
