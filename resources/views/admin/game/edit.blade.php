...
@section('content')
<form class="form-horizontal" action="{{ route('game.update',$game->id) }}" id="formAddEdit" method="POST" enctype="multipart/form-data" name="form">
    {{ csrf_field() }}
    @method('PUT')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <input type="hidden" class="form-control" name="areaId" value="{{ $game->id }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                        <input type="text" class="form-control" placeholder="Name of The Game" name="name" value="{{ $game->name }}" required>
                        @if ($errors->has('name'))
                ...
                <div class="form-group {{ $errors->has('icon') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" placeholder="Icon of The Game" name="icon" value="{{ $game->icon }}" required>
                    @if ($errors->has('icon'))
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->has('orderBy') ? ' has-danger' : '' }}">
                                <input type="number" class="form-control" placeholder="Order By" name="order_by" value="{{ $game->order_by }}" required>
