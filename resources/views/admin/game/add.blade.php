        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" placeholder="Name of The Game" name="name" value="{{ old('name') }}" required>
                    @if ($errors->has('name'))
            ...
            <div class="col-md-3">
                ...
                <div class="form-group {{ $errors->has('icon') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" placeholder="Icon of The Game" name="icon" value="{{ old('icon') }}" required>
                    @if ($errors->has('icon'))
