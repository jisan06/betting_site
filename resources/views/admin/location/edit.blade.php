        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" placeholder="Courier Type Name" name="name" value="{{ $area->name }}">
                    @if ($errors->has('name'))
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group {{ $errors->has('charge') ? ' has-danger' : '' }}">
                            <input type="number" class="form-control" placeholder="travel charge" name="charge" value="{{ $area->charge }}">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group {{ $errors->has('root_plan') ? ' has-danger' : '' }}">
                    <textarea class="form-control" rows="3" placeholder="Gulistan -> Syedabad -> Zatrabari -> Chittahong Road -> and so on" name="root_plan">{{ $area->root_plan }}</textarea>
