                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <input  type="text" class="form-control add_datepicker" id="booking_date" name="booking_date" placeholder="Select Delivery Date" required="" readonly="">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <label for="travel_time">Pickup Time</label>
                                <div class="form-group">
                                    <input type="text" class="form-control " name="travel_time" placeholder="example: 3 pm" required="">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" name="puckup_location" placeholder="write your pickup location" required="" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" name="drop_location" placeholder="write your drop location" required="" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
